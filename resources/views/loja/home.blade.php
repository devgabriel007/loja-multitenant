...
{{-- Banners abaixo dos produtos (apenas se a empresa ativou) --}}
@if($empresa->banner_rodape && $banners->isNotEmpty())
<div id="carouselBannersBottom" class="carousel slide mb-0" data-bs-ride="carousel">
    <div class="carousel-inner">
        @foreach($banners as $i => $banner)
        <div class="carousel-item {{ $i === 0 ? 'active' : '' }}">
            <div class="banner-slide text-white text-center px-4"
    ...
    @if($banners->count() > 1)
    <button class="carousel-control-prev" type="button" data-bs-target="#carouselBannersBottom" data-bs-slide="prev">
        <span class="carousel-control-prev-icon"></span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#carouselBannersBottom" data-bs-slide="next">
        <span class="carousel-control-next-icon"></span>
    </button>
    @endif
</div>
